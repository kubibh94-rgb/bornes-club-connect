...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <img className="logo-hero-img-bg" src="/logoets.webp" />
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 drop-shadow-[0_4px_20px_rgba(0,0,0,0.8)]">
          ...
          <br />
          <span className="text-4xl md:text-6xl text-gradient drop-shadow-lg">Euro Truck Simulator</span>
        </h1>
        ...
        <p className="text-xl md:text-2xl text-foreground mb-12 max-w-2xl mx-auto font-semibold drop-shadow-[0_2px_10px_rgba(0,0,0,0.9)]">
          Rejoignez une communauté passionnée avec des staffs toujours à l&apos;écoute
        </p>

        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <Button variant="hero" size="xl" asChild className="group">
            <a href="https://discord.gg/GcgZmds3JY">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="gradient-card backdrop-blur-sm rounded-2xl p-6 border border-primary/10 hover:border-primary/30 transition-smooth group hover:scale-105">
            ...
            <div className="text-3xl font-bold text-gradient mb-2 drop-shadow-lg">De plus en plus</div>
            <div className="text-sm text-foreground font-medium drop-shadow-md">De membres actifs</div>
          </div>
