  ...
  const socialLinks = [
    {
      ...
      url: "https://www.tiktok.com/@bornesclubets",
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Suivez-nous sur <span className="text-gradient">Tiktok</span>
          </h2>
        ...
        <div className="mt-40 text-center gradient-card rounded-2xl p-8 border border-primary/20">
          ...
          <iframe className="w-full h-96 mt-8 hover:shadow-glow transition-smooth rounded-sm" src="https://discord.com/widget?id=1462881854221979759&theme=dark&lang=fr" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts" />
        </div>
      </div>
    </section>
  );
