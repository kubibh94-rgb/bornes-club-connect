    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        ...
        <p className="text-xl md:text-2xl text-foreground mb-12 max-w-2xl mx-auto font-semibold drop-shadow-[0_2px_10px_rgba(0,0,0,0.9)]">
          Rejoignez une communauté passionnée de plein <span className="text-secondary font-bold drop-shadow-lg">de membres</span> avec des staffs toujours à l&apos;écoute
        </p>
